...
const GENOMES = [
  ...
  { name: 'rancher',    bustThreshold2: 0.22, bustThreshold1: 0.42, dollarBuffer: 3,   cowWeight: 9,   dollarWeight: 2.5, banditPenalty: 20, positionWeight: 0.4, denialWeight: 0,   deckMemory: 0.6,  lethalBias: 1.0, affordMult: 1.6, act1DollarBonus: 0,   act3CowBonus: 3.5, revealBonus: 1.0, maxDraw: 10 },
  ...
  { name: 'deputy',     bustThreshold2: 0.10, bustThreshold1: 0.28, dollarBuffer: 1,   cowWeight: 6,   dollarWeight: 0.5, banditPenalty: 14, positionWeight: 0.3, denialWeight: 1.0, deckMemory: 0.7,  lethalBias: 1.3, affordMult: 1.4, act1DollarBonus: 0.5, act3CowBonus: 2.5, revealBonus: 2.0, maxDraw: 10 },
  ...
  { name: 'prospector', bustThreshold2: 0.12, bustThreshold1: 0.25, dollarBuffer: 1.5, cowWeight: 4.5, dollarWeight: 0,   banditPenalty: 10, positionWeight: 0.2, denialWeight: 0,   deckMemory: 0.55, lethalBias: 1.3, affordMult: 1.3, act1DollarBonus: 1.0, act3CowBonus: 1.8, revealBonus: 2.0, maxDraw: 10 },
  ...
  { name: 'enforcer',   bustThreshold2: 0.30, bustThreshold1: 0.60, dollarBuffer: 3.0, cowWeight: 9.5, dollarWeight: 3,   banditPenalty: 20, positionWeight: 0.5, denialWeight: 0,   deckMemory: 0.75, lethalBias: 1.8, affordMult: 1.9, act1DollarBonus: 0,   act3CowBonus: 3.0, revealBonus: 0.2, maxDraw: 10 },
];
